...
// =======================================================================
//                           DIRICHLET TESTS (BCond::Essential)
// =======================================================================

TEST(DiracCoarseSolver, TestCoarseSolver2DDirichlet_DEC)
{
    mfem::Mesh m =
...
TEST(DiracCoarseSolver, TestCoarseSolver2DDirichlet_FEM)
{
    mfem::Mesh m =
        mfem::Mesh::MakeCartesian2D(4, 4, mfem::Element::TRIANGLE, true);
    auto mesh = std::make_shared<Mesh>(std::move(m));
...
TEST(DiracCoarseSolver, TestCoarseSolver2DNatural_DEC)
{
    mfem::Mesh m =
        mfem::Mesh::MakeCartesian2D(4, 4, mfem::Element::TRIANGLE, true);
    auto mesh = std::make_shared<Mesh>(std::move(m));
...
TEST(DiracCoarseSolver, TestCoarseSolver2DNatural_FEM)
{
    mfem::Mesh m =
        mfem::Mesh::MakeCartesian2D(4, 4, mfem::Element::TRIANGLE, true);
    auto mesh = std::make_shared<Mesh>(std::move(m));
...
TEST(DiracSmoother, SmootherConvergence_GaussSeidel_DEC)
{
    mfem::Mesh m =
        mfem::Mesh::MakeCartesian2D(4, 4, mfem::Element::TRIANGLE, true);
    auto mesh = std::make_shared<Mesh>(std::move(m));

    auto op = std::make_shared<DiracOperator2D>(
        mesh, BCond::Natural, OperatorMode::DEC, MassLumping::RowSum);

    DiracSmoother2D smoother(op);
...
// =======================================================================
//                    SMOOTHER TESTS (BCond::Essential BC)
// =======================================================================

TEST(DiracSmoother, SmootherConvergence_GaussSeidel_Essential_DEC)
{
    mfem::Mesh m =
        mfem::Mesh::MakeCartesian2D(4, 4, mfem::Element::TRIANGLE, true);
    auto mesh = std::make_shared<Mesh>(std::move(m));

    // Initialize Operator with BCond::Essential BCs
    auto op = std::make_shared<DiracOperator2D>(
        mesh, BCond::Essential, OperatorMode::DEC, MassLumping::RowSum);
