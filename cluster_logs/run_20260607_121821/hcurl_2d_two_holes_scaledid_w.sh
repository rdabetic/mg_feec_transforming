...
#SBATCH --output=cluster_logs/run_20260607_121821/hcurl_2d_two_holes_scaledid_w.out
#SBATCH --error=cluster_logs/run_20260607_121821/hcurl_2d_two_holes_scaledid_w.err
