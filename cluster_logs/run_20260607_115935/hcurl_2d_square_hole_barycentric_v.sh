...
#SBATCH --output=cluster_logs/run_20260607_115935/hcurl_2d_square_hole_barycentric_v.out
#SBATCH --error=cluster_logs/run_20260607_115935/hcurl_2d_square_hole_barycentric_v.err
