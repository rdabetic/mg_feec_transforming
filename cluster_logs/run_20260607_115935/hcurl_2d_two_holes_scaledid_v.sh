...
#SBATCH --output=cluster_logs/run_20260607_115935/hcurl_2d_two_holes_scaledid_v.out
#SBATCH --error=cluster_logs/run_20260607_115935/hcurl_2d_two_holes_scaledid_v.err
